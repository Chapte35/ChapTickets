 ...
 */
/**
 * Classes CSS custom par statut — couleurs distinctes pour une lecture rapide.
 * À utiliser avec <Badge className={TICKET_STATUT_CLASSES[statut]}> (sans variant).
 */
export const TICKET_STATUT_CLASSES: Record<TicketStatut, string> = {
  ouvert:            "bg-blue-100 text-blue-800 border-blue-200 dark:bg-blue-900/30 dark:text-blue-300 dark:border-blue-800",
  en_cours:          "bg-amber-100 text-amber-800 border-amber-200 dark:bg-amber-900/30 dark:text-amber-300 dark:border-amber-800",
  en_attente_client: "bg-purple-100 text-purple-800 border-purple-200 dark:bg-purple-900/30 dark:text-purple-300 dark:border-purple-800",
  resolu:            "bg-green-100 text-green-800 border-green-200 dark:bg-green-900/30 dark:text-green-300 dark:border-green-800",
  ferme:             "bg-gray-100 text-gray-600 border-gray-200 dark:bg-gray-800/50 dark:text-gray-400 dark:border-gray-700",
};

/** @deprecated Utiliser TICKET_STATUT_CLASSES. Conservé pour rétrocompatibilité. */
