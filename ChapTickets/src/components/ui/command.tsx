...
/**
 * cmdk v1 : le root s'appelle CommandRoot (export nommé).
 * L'ancien pattern "Command as CommandPrimitive" + "CommandPrimitive.Input"
 * ne fonctionne plus — le contexte store n'est pas établi correctement.
 * On utilise les exports nommés directement.
 */
function Command({
  className,
  ...props
...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      >
        <Command shouldFilter={false} className="[&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:font-medium [&_[cmdk-group-heading]]:text-muted-foreground [&_[cmdk-group]]:px-2 [&_[cmdk-group]:not([hidden])_~[cmdk-group]]:pt-0 [&_[cmdk-input]]:h-12 [&_[cmdk-item]]:px-2 [&_[cmdk-item]]:py-3 [&_[cmdk-item]_svg]:h-5 [&_[cmdk-item]_svg]:w-5">
          {children}
        </Command>
      </DialogContent>
    </Dialog>
